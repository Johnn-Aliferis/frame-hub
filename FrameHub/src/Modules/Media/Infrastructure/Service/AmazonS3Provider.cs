...
namespace FrameHub.Modules.Media.Infrastructure.Service;

public class AmazonS3Provider(IAmazonS3 amazonS3, ILogger<AmazonS3Provider> logger) : IUploadProvider
{
